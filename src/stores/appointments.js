...
export const useAppointmentsStore = defineStore('appointments', () => {
    ...
    watch(date, async () => {
        ...
        if (appointmentId.value) {
            appointmentsByDate.value = data.filter(appointment => appointment._id !== appointment.value)
            time.value = data.filter(appointment => appointment._id === appointment.value)[0].time       
        } else {
